...
sealed class ChannelTlv : Tlv {
    ...
    data class RequestFundingTlv(val request: LiquidityAds.RequestFunds) : ChannelTlv() {
        ...
        companion object : TlvValueReader<RequestFundingTlv> {
            ...
            override fun read(input: Input): RequestFundingTlv = RequestFundingTlv(LiquidityAds.RequestFunds.read(input))
        }
    }
