...
class QuiescenceTestsCommon : LightningTestSuite() {
    ...
    companion object {
        private fun createWalletWithFunds(keyManager: KeyManager, utxos: List<Satoshi>): List<WalletState.Utxo> {
            val script = keyManager.swapInOnChainWallet.getSwapInProtocol(0).pubkeyScript
            return utxos.map { amount ->
                ...
                WalletState.Utxo(parentTx.txid, 0, 42, parentTx, WalletState.Companion.AddressMeta.Derived(0))
            }
        }
