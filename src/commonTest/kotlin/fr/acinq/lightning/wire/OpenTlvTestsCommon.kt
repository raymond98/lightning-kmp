...
class OpenTlvTestsCommon : LightningTestSuite() {
    ...
    fun `channel origin TLV`() {
        val testCases = listOf(
            Pair(
                Origin.PayToOpenOrigin(ByteVector32.fromValidHex("187bf923f7f11ef732b73c417eb5a57cd4667b20a6f130ff505cd7ad3ab87281"), 1234_000.msat, 0.msat),
                Hex.decode("fe47000005 2a 0001 187bf923f7f11ef732b73c417eb5a57cd4667b20a6f130ff505cd7ad3ab87281 00000000000004d2")
            ),
            Pair(
                Origin.PleaseOpenChannelOrigin(ByteVector32("2dadacd65b585e4061421b5265ff543e2a7bdc4d4a7fea932727426bdc53db25"), 1_234_567.msat, 321.sat, 0.msat),
        ...
        testCases.forEach {
            ...
            val encoded = tlvStreamSerializer.write(decoded)
            assertArrayEquals(it.second, encoded)
            val channelOrigin = decoded.get<ChannelTlv.OriginTlv>()?.channelOrigin
